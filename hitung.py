...
try:
    ...
    query = "Seledri saya terdapat bercak cokelat kemerahan kecil, tersebar di daun seledri dan menyebabkan layu, apa nama penyakitnya dan bagaimana solusinya?"  # Ganti dengan pertanyaan yang diinginkan
